...
class main:
    ...
    def code(self):
        ...
        image = Image.open('bg0.jpg')

        # Save the image in PPM format
        image.save('bg0.ppm', 'PPM')

        self.photo=ImageTk.PhotoImage(file=r'bg0.ppm')
        ...
        self.logo = PhotoImage(file=r"pass.jpg")
        ...
        self.log = PhotoImage(file=r"bt1.png")
